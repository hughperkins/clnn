...
function fusiontests.testApplyConvertTanh()
  ...
  tester:asserteq(n1.data.feobj[1].transforms.input.src, 'input')
  tester:asserteq(n1.data.feobj[1].transforms.output.src, 'output')
  tester:asserteq(n1.data.feobj[1].transforms.input.idx, 1)
  tester:asserteq(n1.data.feobj[1].transforms.output.idx, 1)
...
function fusiontests.testApplyConvertTanhSigmoid()
  ...
  tester:asserteq(n2.data.feobj[1].transforms.input.src, 'input')
  tester:asserteq(n2.data.feobj[1].transforms.input.idx, 1)
  tester:asserteq(n2.data.feobj[1].transforms.output.src, 'output')
  tester:asserteq(n2.data.feobj[1].transforms.output.idx, 1)
...
function fusiontests.testFuseTanhSigmoid()
  ...
  tester:asserteq(fdat.feobj[1].transforms.input.src, 'input')
  tester:asserteq(fdat.feobj[1].transforms.input.idx, 1)
  tester:asserteq(fdat.feobj[1].transforms.output.src, 'virtualOutput')
  tester:asserteq(fdat.feobj[1].transforms.output.idx, 1)
  tester:asserteq(fdat.feobj[2].transforms.input.src, 'virtualOutput')
  tester:asserteq(fdat.feobj[2].transforms.input.idx, 1)
