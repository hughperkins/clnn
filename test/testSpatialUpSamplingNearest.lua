...
function clnntest.SpatialMaxPooling_forward()
   ...
   local tm = {}
   local title = string.format('SpatialUpSamplingNearest.forward %dx%dx%d o %d -> %dx%dx%d',
...
function clnntest.SpatialMaxPooling_backward_batch()
   ...
   local tm = {}
   local title = string.format('SpatialUpSamplingNearest.backward %dx%dx%dx%d o %d -> %dx%dx%dx%d',
      bs, from, inj, ini, sf, bs, to, outj, outi)
   times[title] = tm
